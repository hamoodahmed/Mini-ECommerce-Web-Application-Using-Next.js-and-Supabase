              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="mt-1 text-lg font-medium text-gray-900">Products</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="mt-1 text-lg font-medium text-gray-900">Orders</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Add New Product</dt>
                    <dd className="mt-1 text-lg font-medium text-gray-900">Add Product</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          >
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Visit Store</dt>
                    <dd className="mt-1 text-lg font-medium text-gray-900">Store Front</dd>
                  </dl>
                </div>
              </div>
            </div>
